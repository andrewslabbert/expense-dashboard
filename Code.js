...
function doGet(e) {
  try {
    ...
    if (!template) {
        Logger.log("ERROR: HtmlService.createTemplateFromFile('Dashboard') returned null or undefined.");
        return ContentService.createTextOutput("Error: Could not create HTML template. Check file name 'Dashboard.html' exists in the project.");
    }
    ...
    // Logger.log("Returning HtmlOutput.");
    return htmlOutput;
